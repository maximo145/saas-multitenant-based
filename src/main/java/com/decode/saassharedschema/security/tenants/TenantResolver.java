package com.decode.saassharedschema.security.tenants;
...
public class TenantResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return (parameter.getParameterAnnotation(Tenant.class) != null &&
                parameter.getParameterType() == String.class) ||
                (parameter.getParameterAnnotation(TenantId.class) != null &&
